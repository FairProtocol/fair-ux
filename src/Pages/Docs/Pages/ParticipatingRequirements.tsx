    ...
    <div>
      ...
      <>
        <Typography className="docs_details_text">
          To participate in any auction, you would need access to a wallet and then connect this
          wallet to oursite. We support multiple wallets:
        </Typography>
        ...
        <Typography className="docs_details_text one-spacing">
          3. WalletConnect based providers
        </Typography>
        <Typography className="docs_details_text">
