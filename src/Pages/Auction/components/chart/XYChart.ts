...
export const XYChart = (props: XYChartProps): am4charts.XYChart => {
  ...
  volumeAxis.renderer.grid.template.stroke = am4core.color(colors.darkGrey)
  volumeAxis.renderer.grid.template.strokeWidth = 0.5
  volumeAxis.renderer.grid.template.strokeOpacity = 0.5
  volumeAxis.title.fill = am4core.color(colors.darkGrey)
  volumeAxis.renderer.labels.template.fill = am4core.color(colors.darkGrey)

  priceAxis.renderer.grid.template.stroke = am4core.color(colors.darkGrey)
  priceAxis.renderer.grid.template.strokeWidth = 0.5
  priceAxis.renderer.grid.template.strokeOpacity = 0.5
  priceAxis.title.fill = am4core.color(colors.darkGrey)
  priceAxis.renderer.labels.template.fill = am4core.color(colors.darkGrey)
  ...
  // Create serie, yellow line, shows the minimum sell price (x axis) the auctioneer is willing to accept
  ...
  askSeries.stroke = am4core.color(colors.yellow)
  ...
  // Dotted darkGrey line -> shows the Current price, which is the closing price of the auction if
  ...
  priceSeries.stroke = am4core.color(colors.darkGrey)
  ...
  chart.cursor.lineX.stroke = am4core.color(colors.darkGrey)
  chart.cursor.lineX.strokeWidth = 1
  chart.cursor.lineX.strokeOpacity = 0.6
  chart.cursor.lineX.strokeDasharray = '4'

  chart.cursor.lineY.stroke = am4core.color(colors.darkGrey)
  ...
  chart.zoomOutButton.icon.stroke = am4core.color(colors.darkGrey)
  chart.zoomOutButton.icon.strokeWidth = 2
  chart.zoomOutButton.tooltip = new am4core.Tooltip()
  chart.zoomOutButton.tooltip.text = 'Zoom out'

  // Legend
  chart.legend = new am4charts.Legend()
  chart.legend.labels.template.fill = am4core.color(colors.darkGrey)
  ...
  chart.legend.itemContainers.template.tooltipHTML =
    '<div style="darkGrey-space: normal !important;max-width: 300px;padding:0 5px 5px;white-space: pre-wrap;word-wrap: break-word;">{dataContext.dummyData.description}</div>'
